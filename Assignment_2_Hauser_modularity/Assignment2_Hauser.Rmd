...
```
  Mapped data show regional trends in temperature and precipitation changes (Fig. 1 A & B). Temperatures appear to show warming trends in mid-western and northern regions, while coastal regions, particularly the West Coast, appear to experience cooling trends. 
  
  
<!--Chunk for Maps-->
<!--Code that shows spatial distribution of temperature and precipitation change rates-->
```{r climateMaps,fig.cap="Figure 1. A) United States map showing temperature change per year since 1950. Darker blues indicate greater cooling, while darker reds indicate greater warming. B) United States map showing precipitation change per year since 1950. Darker blues indicate greater moisture, while darker oranges indicate drier conditions."}
